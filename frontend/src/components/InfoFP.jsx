  ...
  return (
    <div className="bg-gray-100 py-16">
      <div className="text-center">
        ...
        <h1 className="text-5xl font-bold text-gray-900 my-4">Creative Platform</h1>
      ...
      <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-center justify-items-center">
        <div className="flex flex-col items-center">
          <FaPenNib className="h-12 w-12 text-black mb-4" />
          <h3 className="text-xl font-semibold text-gray-900">Create Story</h3>
          <p className="text-gray-600 mt-2">Start writing your own interactive stories</p>
        </div>
        <div className="flex flex-col items-center">
          <FaCog className="h-12 w-12 text-black mb-4" />
          <h3 className="text-xl font-semibold text-gray-900">Interactive Features</h3>
          <p className="text-gray-600 mt-2">Set up story branches, choices, and multiple endings</p>
        </div>
        <div className="flex flex-col items-center">
          <FaArrowUp className="h-12 w-12 text-black mb-4" />
          <h3 className="text-xl font-semibold text-gray-900">Publishing Options</h3>
          <p className="text-gray-600 mt-2">Authors can publish their completed stories to the platform</p>
        </div>
        <div className="flex flex-col items-center">
          <FaRobot className="h-12 w-12 text-black mb-4" />
        ...
        <div className="flex flex-col items-center">
          <FaUserEdit className="h-12 w-12 text-black mb-4" />
          <h3 className="text-xl font-semibold text-gray-900">Custom Workspaces</h3>
          <p className="text-gray-600 mt-2">Personalize your writing environment to suit your style. Stay organized and focused.</p>
        </div>
        <div className="flex flex-col items-center">
          <FaPeopleArrows className="h-12 w-12 text-black mb-4" />
